...
/**
 * Determines whether to unload all music effects when leave channel.
 * - true: Unload all music effects.
 * - false: (Default) Do not unload any music effect.
 */
@property(nonatomic, assign) BOOL unloadAllEffect;
...
/** The frame rate of the video (fps).
  ...
  *  AgoraVideoFrameRateFps20(20): 20 fps
